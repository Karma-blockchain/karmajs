...
export const credit_request_operation_ = new Serializer(
    "credit_request_operation_",
    {
        fee: asset,
...
export const credit_request_operation = new Serializer(
...
export const credit_approve_operation = new Serializer(
...
export const credit_request_cancel_operation = new Serializer(
...
export const comment_credit_request_operation = new Serializer(
...
export const settle_credit_operation = new Serializer(
